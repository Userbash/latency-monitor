...
const i18n = {
  ...
  zh: {
    ...
    stage: '阶段',
    stageMap: {
      'probing-targets': '选择最近路由',
      'running-samples': '采集样本',
      'computing-results': '计算最终评分',
    },
    lang: '语言',
    theme: '主题',
    screenshot: '截图',
    ...
    tooltips: {
      ...
      spikeRate: '高延迟尖峰占比。',
      bufferbloat: '负载下额外延迟。',
      score: '0 到 100 的综合质量评分。',
    },
    errors: {
      backend: '本地后端不可用',
      externalLink: '无法打开外部链接',
      screenshot: '截图保存失败',
      screenshotUnavailable: '仅桌面模式支持截图',
      screenshotCanceled: '截图保存已取消',
    },
